...
class HandDrawer:
    ...
    def draw(self, frame: np.ndarray, gesture_result: Any) -> np.ndarray:
    ...
    def _draw_landmarks(self, frame: np.ndarray, hand_landmarks: Any, color: Tuple[int, int, int]) -> None:
        h, w = frame.shape[:2]
    ...
    def _draw_connections(self, frame: np.ndarray, hand_landmarks: Any, color: Tuple[int, int, int]) -> None:
        h, w = frame.shape[:2]
