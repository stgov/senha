...
class PersonReID:
    ...
    def _init_kalman_embedding(self, initial_embedding: np.ndarray, embedding_dim: int = 320) -> cv2.KalmanFilter:
        """
    ...
    def get_stats(self) -> Dict[str, int]:
        ...
        active = sum(1 for p in self.persons.values() if (self.current_frame - p.last_seen_frame) < 30)
        return {
