"""
Extractor de embeddings para Re-ID de personas.
"""
...
class EmbeddingExtractor:
    """Extrae embeddings de 320 dimensiones (HSV+HOG+Gradients)."""
    
    def __init__(self):
        """Inicializar extractor."""
        self.embedding_dim = 320
    
    def extract(self, frame: np.ndarray, bbox: tuple[int, int, int, int], debug: bool = False) -> np.ndarray:
        """
        Extrae embedding de 320 dimensiones combinando HSV, HOG y gradientes.
