#!/usr/bin/env python3
"""
Sistema de Reconocimiento y Re-Identificación de Personas con Gestos.
...
from src.core.app import TrackerApp
...
def main():
    ...
    config = TrackerConfig(
        ...
        window_title="Person Re-ID Tracker"
    )
    ...
    try:
        print("\n" + "="*60)
        print("  Sistema de Re-Identificación de Personas")
        print("="*60)
        print("\n📋 Funcionalidades:")
