...
class PoseDrawer:
    ...
    def draw(self, frame: np.ndarray, pose_result: Any) -> np.ndarray:
    ...
    def _draw_skeleton(self, frame: np.ndarray, pose_landmarks: Any) -> None:
    ...
    def _draw_bbox(self, frame: np.ndarray, pose_landmarks: Any, idx: int, w: int, h: int) -> None:
        ...
        cx, cy = self.bbox_smoother.calculate_centroid(x_min, y_min, x_max, y_max)
